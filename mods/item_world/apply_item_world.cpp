...
int main() {
    ...
    printf("=================================================================\n");
    printf("  DISGAEA MAYHEM - ITEM WORLD HOOK (AUTO-DISCOVERY)\n");
    printf("=================================================================\n");
    ...
    if (!AutoDiscoverDllPath(pid, "item_world", "item_world.dll", dll_full_path, sizeof(dll_full_path))) {
        printf("[ERRO] Nao foi possivel auto-descobrir o arquivo item_world.dll.\n");
        printf("       Certifique-se de que a pasta 'mods/item_world' esta presente.\n");
        return 1;
    }
    ...
    if (pRemoteMem) {
        ...
        if (hThread) {
            ...
            CloseHandle(hThread);
            printf("[SUCESSO] Hook residente item_world.dll ativo na memoria do jogo!\n");
