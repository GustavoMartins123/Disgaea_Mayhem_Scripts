...
O SmokeAPI fornece o desbloqueio e injeta as entradas do inventário. Este plugin
torna reutilizáveis os cinco consumíveis exibidos na loja de conteúdo especial:
...
O SmokeAPI instalado na pasta do jogo deve manter a injeção automática das
definições `1` a `5`. Se essa configuração estiver ausente, os consumíveis não
aparecem para resgate. O plugin não cria entradas substitutas.
