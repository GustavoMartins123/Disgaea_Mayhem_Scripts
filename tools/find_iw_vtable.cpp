...
int main() {
    ...
    uint64_t vtable_iw = 0x140A251F0;
    size_t off = va_to_offset(vtable_iw);
    printf("VTable IW 0x140A251F0 -> file offset: 0x%zX\n", off);
    if (off) {
        printf("First 4 virtual functions of CItemWorldData:\n");
        for (int i = 0; i < 4; ++i) {
