...
O plugin acompanha a rotina da votação na RVA `0x004D2150`. Enquanto estiver
...
A versão anterior usava `0x004D19E0`, que pertence à preparação do estado da
votação. Essa preparação zerava a marca antes da decisão e, por isso, a proposta
continuava podendo ser rejeitada.
